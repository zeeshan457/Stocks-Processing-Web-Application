...
import com.example.app.views.dashboard.DashboardView;
...
public class MainLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        if (accessChecker.hasAccess(ViewStocksView.class)) {
            nav.addItem(new AppNavItem("View Stocks", ViewStocksView.class, "la la-columns"));

        }
        if (accessChecker.hasAccess(ProcessingView.class)) {
            nav.addItem(new AppNavItem("Processing", ProcessingView.class, "la la-file"));
